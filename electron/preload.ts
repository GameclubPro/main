...
import type { LauncherConfig, LauncherDeviceStart, LauncherSnapshot } from './launcherCore.js';
...
const api = {
  ...
  logoutAccount: () => ipcRenderer.invoke('launcher:logoutAccount') as Promise<LauncherSnapshot>,
